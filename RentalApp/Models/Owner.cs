namespace RentalApp.Models
{
    public class Owner : User
    {
        ...
        //I added constructor:
        public Owner(int userId, string name, string email, string address, string phoneNumber, int someOtherParameter)
            : base(userId, name, email, address, phoneNumber, someOtherParameter)
        {
